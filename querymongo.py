...
"""
print ("Getting the analytics in {} at {}.\n".format(date,location))
...
pipe = [{'$match': {'$and':[{'locationtext':location},
                            {'starttime': {'$gte': '{} 0:00'.format(date)}},
                            {'starttime': {'$lt': '{} 0:05'.format(date)}}]}}, {'$group': {'_id': None,'average_speed': {'$avg': '$speed'}}}]
...
pipe = [{'$match': {'$and':[{'locationtext':location},
                           {'starttime': {'$gte': '{} 0:50'.format(date)}},
                            {'starttime': {'$lt': '{} 0:55'.format(date)}}]}}, {'$group': {'_id': None,'average_speed': {'$avg': '$speed'}}}]
average_travel_foster_find= loop.aggregate(pipe)
